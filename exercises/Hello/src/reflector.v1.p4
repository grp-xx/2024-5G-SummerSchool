...
control MyEgress(inout headers hdr,
    ...
    // add an array of 8 counters associated with the egress interfaces (0..7)
    // The implementation of counters of Bmv2 tracks both packets and bytes regardless of the value of CounterType...
